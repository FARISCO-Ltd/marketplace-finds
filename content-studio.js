...
function render(now = performance.now()) {
  ...
  if (watermarkEnabled.checked) { rr(118, 1028, 258, 46, 16); ctx.fillStyle = 'rgba(7,27,67,.52)'; ctx.fill(); ctx.fillStyle = 'rgba(255,255,255,.88)'; ctx.font = '700 20px Arial'; ctx.textAlign = 'center'; ctx.fillText(handleInput.value || '@Marketplace.Finds', 247, 1058); ctx.textAlign = 'left'; }
